...
from books.controllers.amqp import AMQPBookController
from books.controllers.http import HTTPBookController
from books.infrastructure.broker import new_broker
from books.ioc import AppProvider
